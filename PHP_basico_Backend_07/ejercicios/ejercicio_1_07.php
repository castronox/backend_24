...
<body>
	...
	<form method="post" autocomplete="off">
		...
		<fieldset>
			...
			<label>Dni:</label> <br /> <input type="text" name="dni" required
				maxlength="9" /> <br />
			<br /> <label>Nombre:</label> <br /> <input type="text" name="nombre" />
			<br />
			<br /> <label>Apellidos</label> <br /> <input type="text"
				name="apellidos" /> <br />
			<br /> <label>Fecha de nacimiento</label> <br /> <input type="date"
				name="nacimiento" /> <br />
			<br /> <label>Email</label> <br /> <input type="email" name="email"
				required /> <br />
			<br /> <label>Teléfono</label> <br /> <input type="number"
				name="telefono" maxlength="16" /> <br />
			<br /> <label>Dirección</label> <br /> <input type="text"
				name="direccion" /> <br />
			<br /> <label>Código Postal</label> <br /> <input type="number"
				name="cp" maxlength="5" /> <br />
			<br /> <label>Población</label> <br /> <input type="text"
				name="poblacion" /> <br />
			<br /> <label>Provincia</label> <br /> <input type="text"
				name="provincia" /> <br />
