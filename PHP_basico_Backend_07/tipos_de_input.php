...
<body>
	...
	<form method="post" autocomplete="off">
		...
		<fieldset>
			...
			<legend>Datos</legend>
			<label>Usuario:</label> <input type="text" name="usuario"> <br> <label>Clave:</label>
			<input type="password" name="pwd" /> <br /> <input type="radio"
				name="sexo" value="H" checked /> <label>Hombre</label> <br /> <input
				type="radio" name="sexo" vale="M" /> <label>Mujer</label> <br /> <select
				name="provincia">
		...
		<fieldset>
			...
			<input type="checkbox" name="bici" value="1" /> <label>Tengo bici</label>
			<br /> <input type="checkbox" name="moto" value="1" /> <label>Tengo
				moto</label> <br /> <input type="checkbox" name="checkbox" value="1" />
			<label>Tengo coche</label> <br />
