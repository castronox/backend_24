...
class Upload
{
     ...
     *            extensión a añadir al nombre calculado.
     * @param string $prefix
     *            prefijo a añadir al nombre calculado.
     * @param bool $moreEntropy
     *            más entropía?
     *            
     * @return string el nombre calculado con el prefijo y la extensión.
     */
    public static function uniqueName(string $extension = '', string $prefix = '', bool $moreEntropy = false): string
    {
    ...
    public static function save(string $key = 'file', // clave de $_FILES (nombre del input)
    ...
    string
    {
        ...
        $nombreFichero = $unique ? self::uniqueName(pathinfo($file['name'], PATHINFO_EXTENSION), $prefix, true) : $file['name'];
